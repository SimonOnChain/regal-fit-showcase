          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/motiv_club_fitness/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white/70 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 group border border-blue-300">
                  <Instagram className="h-5 w-5 text-slate-600 group-hover:text-white" />
                </a>
                <a href="https://www.facebook.com/motivclubmeknes" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white/70 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 group border border-blue-300">
                  <Facebook className="h-5 w-5 text-slate-600 group-hover:text-white" />
                </a>
                <a href="https://www.tiktok.com/@motivclubmeknes" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white/70 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 group border border-blue-300">
                  <svg className="h-5 w-5 text-slate-600 group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
