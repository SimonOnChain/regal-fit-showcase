        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <div className="space-y-8 animate-fade-in">
              <p className="text-base md:text-lg lg:text-xl xl:text-2xl text-slate-700 leading-relaxed font-light">
              ...
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-slate-800 animate-fade-in stagger-2"
